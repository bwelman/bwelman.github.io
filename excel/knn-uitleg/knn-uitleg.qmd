...
![Lengte van 8 personen.](knn-1dim-data.png){#fig-knn-1dim-data}
...
![Afbeelding van de lengte van de personen op een denkbeeldige meetlat.](knn-1dim-grafiek.png){#fig-knn-1dim-grafiek}
...
![Lengte en gewicht van de personen.](knn-2dim-data.png){#fig-knn-2dim-data}

In @fig-knn-2dim-grafiek is een spreidingsdiagram van gewicht tegen lengte te zien.

![Spreidingsdiagram van gewicht tegen lengte van de personen.](knn-2dim-grafiek.png){#fig-knn-2dim-grafiek}
...
![Lengte en gewicht van de personen.](knn-2dim-norm-data.png){#fig-knn-2dim-norm-data}

![Spreidingsdiagram van gewicht tegen lengte van de personen.](knn-2dim-norm-grafiek.png){#fig-knn-2dim-norm-grafiek}
