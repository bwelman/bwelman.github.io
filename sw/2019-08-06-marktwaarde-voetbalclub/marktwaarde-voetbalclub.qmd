...
![Selectie van de tabel met de gewenste gegevens.](club-01.png){#fig-club-01}

Klik op **Gegevens transformeren**. Power Query Editor wordt opgestart met daarin de gegevens.

![Beginscherm Power Query Editor.](club-02.png){#fig-club-02}
...
![Twee kolommen zijn verwijderd, namen van kolommen gewijzigd alsmede de naam van de query zelf.](club-03.png){#fig-club-03}
...
![Dialoogscherm voor het splitsen van een kolom op basis van een scheidingsteken.](club-04.png){#fig-club-04}
...
![Nieuwe kolom voor de geboortedatum.](club-05.png){#fig-club-05}
...
![Kolom Geboortedatum voorzien van de gewenste opmaak.](club-06.png){#fig-club-06}
...
![Nieuwe kolom Marktwaarde.](club-07.png){#fig-club-07}
...
![Totaalrij voor Marktwaarde toegevoegd.](club-08.png){#fig-club-08}
