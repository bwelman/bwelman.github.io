...
```{r}
#| label: fig-vb02
#| fig-cap: "Grafiek met gespecificeerd domein voor x en iets dikkere blauwe lijn."
...
```{r}
#| label: fig-vb03
#| fig-cap: "Twee grafieken met elkaar vergeleken."
...
```{r}
#| label: fig-vb04
#| fig-cap: "Meerdere grafieken in één figuur."
#| preview: true
...
```{r}
#| label: fig-vb05
#| fig-cap: "Logaritmische schaal voor de Y-as"
...
```{r}
#| label: fig-vb06
#| fig-cap: "Logaritmische schaal voor zowel de Y-as als de X-as"
